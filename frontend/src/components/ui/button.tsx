  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-lg font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        mic: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-button rounded-full aspect-square",
        confirm: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-button",
        cancel: "bg-muted text-muted-foreground hover:bg-destructive hover:text-destructive-foreground",
        action: "bg-secondary text-secondary-foreground hover:bg-secondary/90 shadow-button",
      },
      size: {
